...
public class MyadapterItemPurchase extends RecyclerView.Adapter<MyadapterItemPurchase.MyViewHolder> {
    private ArrayList<DetailsItemPurchase> list;
    ...
    public MyadapterItemPurchase(ArrayList<DetailsItemPurchase> list) {
        this.list = list;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public MyadapterItemPurchase.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        // if(Integer.parseInt(hashMap.get(1)) == position) {'
        try {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RealmResults results = realm_3.where(DetailsItemPurchase.class).findAll();
                ...
                v.getContext().startActivity(new Intent(v.getContext(), purchase.class));
    ...
    public MyadapterItemPurchase(Context context)
    {
