...
public class PurchaseReturnAdapter extends RecyclerView.Adapter<PurchaseReturnAdapter.MyViewHolder> {
    private ArrayList<DetailsItemPurchase1> list;
    ...
    public PurchaseReturnAdapter(ArrayList<DetailsItemPurchase1> list) {
        this.list = list;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public PurchaseReturnAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
        // create a new view
