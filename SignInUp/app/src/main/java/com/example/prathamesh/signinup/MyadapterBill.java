...
public class MyadapterBill extends RecyclerView.Adapter<MyadapterBill.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.view_2.setText(Integer.toString(list_bill.get(position).getTotal()));
        holder.view_3.setText(Integer.toString(list_bill.get(position).getReceived()));
        holder.view_4.setText(Integer.toString(list_bill.get(position).getBalance()));
       ...
       holder.edit.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               ...
               intent.putExtra("3", Integer.toString(list_bill.get(position).getTotal()));
               intent.putExtra("4", Integer.toString(list_bill.get(position).getReceived()));
               intent.putExtra("5", Integer.toString(list_bill.get(position).getBalance()));
