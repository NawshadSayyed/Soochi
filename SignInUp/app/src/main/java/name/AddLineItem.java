...
import com.example.prathamesh.signinup.ItemList;
...
public class AddLineItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(key == 1) {
            ...
            ArrayList<DetailsItemSale> list_1 = new ArrayList<DetailsItemSale>(realm_1.where(DetailsItemSale.class).findAll());
            Log.d("position1", String.valueOf(list_1.size()));
        ...
        button_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AddLineItem.this, Sale.class);
